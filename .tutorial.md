...
To manually execute the asset, run the bash script ending with `.sh` on the terminal, e.g.  `./12c-gcp-setup-cloudrun-app-odoo.sh`.
...
For more information about a command, copy and paste the command at https://chat.openai.com 
